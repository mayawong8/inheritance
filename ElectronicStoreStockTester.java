public class ElectronicStoreStockTester {
        ...
        public static ElectronicStore createStore2(){
            ...
            store2.addProduct(d1);
            store2.addProduct(d2);
            store2.addProduct(l1);
            store2.addProduct(l2);
            store2.addProduct(f1);
            store2.addProduct(f2);
            store2.addProduct(t1);
            store2.addProduct(t2);
            return store2;
        }
        ...
        public static ElectronicStore createStore3(){
            ...
            store3.addProduct(d1);
            store3.addProduct(d2);
            store3.addProduct(l1);
            store3.addProduct(l2);
            store3.addProduct(f1);
            store3.addProduct(f2);
            store3.addProduct(t1);
            store3.addProduct(t2);
            store3.addProduct(d3);
            store3.addProduct(d4);
            store3.addProduct(l3);
            store3.addProduct(l4);
            store3.addProduct(f3);
            store3.addProduct(f4);
            store3.addProduct(t3);
            store3.addProduct(t4);
            return store3;
        }
    }
